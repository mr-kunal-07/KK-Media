...
const Navbar = () => {
    ...
    return (
        <div className="select-none flex justify-between items-center w-full px-5 py-3 shadow-lg relative z-50 bg-white">
            {/* Logo */}
            <img src="./logo2.png" className="sm:w-36 object-contain w-35 mt-[-45px] mb-[-45px] " alt="Logo" />

            {/* Desktop Nav */}
            <ul className="hidden md:flex poppins-semibold gap-8 items-center text-lg cursor-pointer">
                <li>Home</li>
                <li>About</li>
                <li>Services</li>
                <li>Contact</li>
